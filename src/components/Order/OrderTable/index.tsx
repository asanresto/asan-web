...
const OrderTable = ({ data, paginationMetadata }: { data?: any[]; paginationMetadata?: PaginationMetadata }) => {
  ...
  const columns = useMemo<ColumnDef<any>[]>(
    () => [
      ...
      //   accessorKey: "name",
      //   cell: (info) => {
      //     return <NextLink href={`/orders/details/${info.row.original.id}`}>{info.getValue() as any}</NextLink>;
      //   },
      // },
