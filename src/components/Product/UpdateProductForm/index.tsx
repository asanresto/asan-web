...
import { UpdateProductValues, updateProductSchema } from "@/models/product/product";
import { useAppDispatch } from "@/store";
import { booleanActions } from "@/store/slices/boolean";
import { zodResolver } from "@hookform/resolvers/zod";
import { Box, Button, Card, CardActions, Fab, Grid, InputBase, Stack } from "@mui/material";
import { visuallyHidden } from "@mui/utils";
import { Controller, FormProvider, useFieldArray, useForm, useFormContext } from "react-hook-form";
import ProductImageCropperDialog from "../CreateProductForm/ProductImageCropperDialog";
import ProductOverallSaleChart from "../ProductOverallSaleChart";
import ProductStock from "../ProductStock";
import { useMutation } from "urql";
import { UpdateProductMutation, UpdateProductMutationVariables } from "@/graphql/types";
import { updateProductDoc } from "@/graphql/documents/product";
